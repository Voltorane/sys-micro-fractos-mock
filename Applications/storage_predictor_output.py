...
def run():
    with grpc.insecure_channel('127.0.0.1:2181') as channel:       
        ...
        next_request = [f"PREDICTOR,127.0.0.1:2182,img_width:{img_width},img_height:{img_height},client_id:{client_id}",
                        f"STORAGE,127.0.0.1:2181,name:{output_name},storage_id:{client_id}"]
