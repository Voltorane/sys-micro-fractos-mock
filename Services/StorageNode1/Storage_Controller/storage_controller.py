...
def serve(run_with_zookeeper=False, verbose=False, name=""):
    ...
    service_rpc_pb2_grpc.add_OutputCollectorServicer_to_server(OutputCollector(run_with_zookeeper, verbose, name), server)
    service_rpc_pb2_grpc.add_DataSenderServicer_to_server(DataSender(run_with_zookeeper, verbose, name), server)
